  ...
  return (
   <nav>
    ...
    <ul className='desktopmenu'>
       ...
       <Link to="ppp" activeClass ='active' spy={true} smooth={true} duration={1500}> <li>About</li> </Link> 
       <Link to="contact" activeClass ='active' spy={true} smooth={true} duration={1500}> <li>Contact</li></Link>
       <Link to="contact" activeClass ='active' spy={true} smooth={true} duration={1500}> <li>Add</li></Link>
